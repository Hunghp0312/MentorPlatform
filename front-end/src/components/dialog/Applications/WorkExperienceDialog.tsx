...
//       isValid = false;
//     } else if (
//       parseInt(formState.startDate) < 1900 ||
//       parseInt(formState.startDate) > currentYear
//     ) {
...
//     } else if (
//       formState.endDate &&
//       (parseInt(formState.endDate) < parseInt(formState.startDate) ||
//         parseInt(formState.endDate) > currentYear + 5)
//     ) {
//       newErrors.endDate = `End year must be between ${
//         formState.startDate
//       } and ${currentYear + 5}.`;
//       isValid = false;
//     }
