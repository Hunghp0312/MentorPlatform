    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResourceDownload", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ResourceDownload_DocumentContent_DocumentContentId",
                        column: x => x.DocumentContentId,
                        principalTable: "DocumentContent",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_ResourceDownload_Resource_ResourceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ResourceDownload_DocumentContentId",
                table: "ResourceDownload",
                column: "DocumentContentId");

            migrationBuilder.CreateIndex(
                name: "IX_ResourceDownload_ResourceId",
                table: "ResourceDownload",
                column: "ResourceId");
